...
function mostrarProximoGrafico() {
  const graficos = ['barChart', 'pieChart', 'lineChart'];
  ...
  // Avance para o próximo gráfico
  graficoAtual = (graficoAtual + 1) % graficos.length;

  // Exiba o próximo gráfico
  document.getElementById(graficos[graficoAtual]).style.display = 'flex';
}
